    ...
    return (
      <Container textAlign='center'>
        ...
        {this.state.isGameActive ? (
          <div>
          <Button data-cy="rock-button" onClick={() => {this.selectItem("Rock"); this.startGame()}}>
          Rock
        </Button>
        <Button data-cy="paper-button" onClick={() => {this.selectItem("Paper"); this.startGame()}}>
          Paper
        </Button>
        <Button
          data-cy="scissors-button"onClick={() => {this.selectItem("Scissors"); this.startGame()}}>
          Scissors
        </Button>
